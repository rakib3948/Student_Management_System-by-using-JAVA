 ...
 * @author User
 */
public class ALoginorRegistration extends javax.swing.JFrame {

    /**
     * Creates new form ALoginorRegistration
     */
    public ALoginorRegistration() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Admin Select Here.....");
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/registration_80px.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        TRegistration tr1 = new TRegistration();
        tr1.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ALoginorRegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ALoginorRegistration().setVisible(true);
            }
        });
    }
