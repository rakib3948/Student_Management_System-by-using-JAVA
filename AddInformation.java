...
public class AddInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField5.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        ...
        jLabel11.setText("BE Lab");

        jLabel12.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        jLabel12.setText("SP 2");

        jComboBox2.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A+", "A", "A-", "B", "B+", "C", "D", "F" }));

        jComboBox3.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A+", "A", "A-", "B", "B+", "C", "D", "F" }));

        jComboBox4.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A+", "A", "A-", "B", "B+", "C", "D", "F" }));

        jComboBox6.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        jComboBox6.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A+", "A", "A-", "B", "B+", "C", "D", "F" }));

        jComboBox7.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A+", "A", "A-", "B", "B+", "C", "D", "F" }));

        jComboBox8.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        jComboBox8.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A+", "A", "A-", "B", "B+", "C", "D", "F" }));

        jComboBox9.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        jComboBox9.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A+", "A", "A-", "B", "B+", "C", "D", "F" }));
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "First Name", "Last Name", "Gender", "Phone", "OOP", "OOP Lab", "BE", "BE Lab", "SP 2", "E Math", "FMA"
            }
        ));
