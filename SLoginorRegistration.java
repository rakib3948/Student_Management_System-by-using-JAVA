 ...
 * @author User
 */
public class SLoginorRegistration extends javax.swing.JFrame {

    /**
     * Creates new form LoginorRegistration
     */
    public SLoginorRegistration() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Student Select Here.....");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        SRegistration sr1 = new SRegistration();
        sr1.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SLoginorRegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SLoginorRegistration().setVisible(true);
            }
        });
    }
